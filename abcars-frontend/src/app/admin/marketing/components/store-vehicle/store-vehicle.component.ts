...
import {UpdateVehicle, BrandsResponse, Brand, Line, LinesResponse, Model, Body, ModelsResponse, VersionsResponse, Version, BodiesResponse, VehicleUpdateResponse, GralResponse, VehicleStoreResponse} from '@interfaces/vehicle_data.interface';
...
export class StoreVehicleComponent  implements OnInit{
  ...
  public InitForm(){
    ...
    this.getModels(this.getBrands.name);
