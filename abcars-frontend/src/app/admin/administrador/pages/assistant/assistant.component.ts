...
export class AssistantComponent {
  ...
  constructor(private assistantService: AssistantService) {
    this.messages.push({
      role: 'assistant',
      content: 'Hola, soy el asistente de ABCars. Puedes preguntarme sobre usuarios, vehículos, sucursales, valuaciones o citas. Por ejemplo: "¿Cuántos usuarios hay?", "Resumen del sistema", "Lista sucursales".'
    });
  }
