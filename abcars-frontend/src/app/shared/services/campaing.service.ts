...
import { CampaignPlacement } from '../constants/fallback-media';
...
export class CampaingService {
    ...
    public getCampaingPublic(placement: CampaignPlacement = 'showroom'): Observable<GetcampaingResponse> {
        return this._http.post<GetcampaingResponse>(`${this.baseUrl}/api/campaigns/active`, { placement });
    }
