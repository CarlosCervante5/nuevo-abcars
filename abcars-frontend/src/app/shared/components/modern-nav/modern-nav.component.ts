      ...
      <div class="w-full mx-auto px-12 lg:px-16">
        <div class="flex justify-between items-center h-24">
          ...
          <div class="hidden lg:flex items-center space-x-8">
            ...
            <a [routerLink]="['/financiamiento']" class="nav-link" (click)="scrollToTop()" [ngClass]="(isScrolled || theme === 'dark') ? 'text-gray-700 hover:text-yellow-600' : 'text-white font-bold hover:text-yellow-300'">Simulador de Crédito</a>
          </div>
