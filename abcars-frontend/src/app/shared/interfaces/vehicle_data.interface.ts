...
export interface Vehicle {
    ...
    motorcycle_brakes?: string | null;
    motorcycle_starting_system?: string | null;
    motorcycle_digital_dashboard?: 'yes' | 'no' | null;
    motorcycle_engine_cycle?: string | null;
    motorcycle_power_hp?: number | null;
    motorcycle_max_speed_kmh?: number | null;
    motorcycle_suspension?: string | null;
