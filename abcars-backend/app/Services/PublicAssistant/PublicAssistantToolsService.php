...
class PublicAssistantToolsService
{
    ...
    private function getVehicleDetails(array $args): array
    {
        ...
        $data = [
            ...
            'detalle_moto'   => $vehicle->type === 'moto' ? array_filter([
                'frenos'                 => $vehicle->motorcycle_brakes,
                'sistema_arranque'       => $vehicle->motorcycle_starting_system,
                'tablero_digital'        => $vehicle->motorcycle_digital_dashboard === 'yes' ? 'Sí' : ($vehicle->motorcycle_digital_dashboard === 'no' ? 'No' : null),
                'motor'                  => $vehicle->motorcycle_engine_cycle,
                'potencia_hp'            => $vehicle->motorcycle_power_hp !== null ? $vehicle->motorcycle_power_hp . ' hp' : null,
                'velocidad_maxima'       => $vehicle->motorcycle_max_speed_kmh !== null ? $vehicle->motorcycle_max_speed_kmh . ' km/h' : null,
                'suspension'             => $vehicle->motorcycle_suspension,
            ], fn ($v) => $v !== null && $v !== '') : null,
