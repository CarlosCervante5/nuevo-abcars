...
class CustomerReward extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->table = env('DB_TABLE_PREFIX', '') . 'customer_reward';
    }
    ...
    {
        return $this->hasMany(RewardPoint::class, 'customer_reward_id');
    }
    ...
    /**
     * Find the customer reward by UUID instead of ID
     *
     * @param string $uuid
     * @return \App\Models\CustomerReward|null
     */
