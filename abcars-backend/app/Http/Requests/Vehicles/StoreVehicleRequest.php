...
class StoreVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'motorcycle_brakes' => 'nullable|string|max:255',
            'motorcycle_starting_system' => 'nullable|string|max:255',
            'motorcycle_digital_dashboard' => 'nullable|in:yes,no',
            'motorcycle_engine_cycle' => 'nullable|string|max:100',
            'motorcycle_power_hp' => 'nullable|numeric|min:0|max:99999.99',
            'motorcycle_max_speed_kmh' => 'nullable|integer|min:0|max:9999',
            'motorcycle_suspension' => 'nullable|string|max:255',
