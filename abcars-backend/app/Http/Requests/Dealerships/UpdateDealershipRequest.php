...
class UpdateDealershipRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'service_types' => 'sometimes|array|min:1',
