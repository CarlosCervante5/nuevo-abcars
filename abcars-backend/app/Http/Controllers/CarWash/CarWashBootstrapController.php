...
class CarWashBootstrapController extends Controller
{
    public function staff(Request $request)
    {
        ...
        try {
            ...
            Artisan::call('migrate', [
                '--force' => true,
                '--path' => 'database/migrations/2026_09_08_220000_create_carwash_loyalty_tables.php',
            ]);
            $migrateOutput .= Artisan::output();

            Artisan::call('migrate', [
                '--force' => true,
                '--path' => 'database/migrations/2026_09_08_230000_add_carwash_order_types_and_vin.php',
            ]);
            $migrateOutput .= Artisan::output();

            Artisan::call('migrate', [
                '--force' => true,
                '--path' => 'database/migrations/2026_09_08_240000_create_carwash_customers_table.php',
            ]);
            $migrateOutput .= Artisan::output();

            Artisan::call('migrate', [
                '--force' => true,
                '--path' => 'database/migrations/2026_09_10_160000_add_category_to_carwash_products.php',
            ]);
            $migrateOutput .= Artisan::output();
